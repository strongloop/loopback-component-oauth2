...
Server.prototype.serializeClient = function(fn, done) {
  ...
  (function pass(i, err, obj) {
    ...
    var layer = stack[i];
    if (!layer) {
      return done(new Error(g.f('Failed to serialize client. Register serialization function using {{serializeClient()}}.')));
    }
...
Server.prototype.deserializeClient = function(fn, done) {
  ...
  (function pass(i, err, client) {
    ...
    var layer = stack[i];
    if (!layer) {
      return done(new Error(g.f('Failed to deserialize client. Register deserialization function using {{deserializeClient()}}.')));
    }
