...
// "OAuth token"
var OAuthToken = loopback.createModel('AccessToken', {
  // "access token"
  accessToken: {
    type: String,
    index: {
...
var OAuthAuthorizationCode = loopback.createModel('AuthorizationCode', {
  code: {
    type: String,
    index: {
      unique: true
...
OAuthToken.autoAttach = DB;
OAuthAuthorizationCode.autoAttach = DB;
ClientRegistration.autoAttach = DB;
OAuthPermission.autoAttach = DB;
OAuthScope.autoAttach = DB;
OAuthResource.autoAttach = DB;
