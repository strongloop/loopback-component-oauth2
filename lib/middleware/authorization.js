...
module.exports = function(server, options, validate, immediate) {
  ...
  if (!server) { throw new TypeError(g.f('{{oauth2orize.authorization}} middleware requires a {{server}} argument')); }
  if (!validate) { throw new TypeError(g.f('{{oauth2orize.authorization}} middleware requires a {{validate}} function')); }
