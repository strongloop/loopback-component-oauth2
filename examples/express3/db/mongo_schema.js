...
var OAuthResourceSchema = new Schema({
	operations : [ {
		type : String,
		enum : [ "ALL", "GET", "POST", "PUT", "DELETE", "HEAD", "OPTIONS",
				"PATCH" ]
...
exports.OAuthAuthorizationCode = mongoose.model('OAuthAuthorizationCode',
		OAuthAuthorizationCodeSchema);
exports.ClientRegistration = mongoose.model('ClientRegistration',
		ClientRegistrationSchema);
exports.OAuthPermission = mongoose.model('OAuthPermission',
		OAuthPermissionSchema);
